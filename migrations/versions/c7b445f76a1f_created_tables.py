...
Revision ID: c7b445f76a1f
Revises: 
Create Date: 2025-10-04 16:47:29.605513
...
def upgrade():
    ...
    sa.Column('description', sa.Text(), nullable=True),
    sa.Column('is_active', sa.Boolean(), nullable=False),
    sa.Column('status', sa.Enum('ACTIVE', 'INACTIVE', name='usertypestatusenum'), nullable=False),
    sa.Column('created_at', sa.DateTime(), nullable=False),
    sa.Column('updated_at', sa.DateTime(), nullable=False),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    sa.Column('status', sa.Enum('ACTIVE', 'INACTIVE', name='userfieldstatustypeenum'), nullable=False),
